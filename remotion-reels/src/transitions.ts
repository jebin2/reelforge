...
import { ReelTransition } from "./types";

export const TRANSITION_FRAMES = 18; // ~0.75s at 24fps

// Custom "toss" — outgoing panel spins/shrinks away, incoming rises up
...
export function getPresentation(transition: ReelTransition): TransitionPresentation<Record<string, never>> {
  switch (transition) {

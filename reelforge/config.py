...
ANIME_LONG_RECAP_SYSTEM_PROMPT = BASE_PATH + "/reelforge/prompt/anime_long_recap_system_prompt.md"
...
MOVIE_LONG_RECAP_SYSTEM_PROMPT = BASE_PATH + "/reelforge/prompt/movie_long_recap_system_prompt.md"
